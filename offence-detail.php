...
?>
					...
					<li><a class="active" href="main.html"><i class="glyphicon glyphicon-th"></i> Dashboard </a></li>
...
?>
			...
			<div class="header-light text-center">
                                ...
                                <br>
								<div class="mapouter"><div class="gmap_canvas"><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3023.9503398796587!2d-73.9940307!3d40.719109700000004!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89c25a27e2f24131%3A0x64ffc98d24069f02!2sCANADA!5e0!3m2!1sen!2sin!4v1441710758555" allowfullscreen></iframe><a href="#"></a></div>
							<style>.mapouter{text-align:right;height:150px;width:650px;}.gmap_canvas 
                            ...
                            <div class="content-light ">
							 <table class="table table-bordered">
									...
									<tr>
										...
										<tr>
                                        	<td style="background-color:#3dd;">Offender's Name:</td>
                                        	<td><?php echo $row['vehicle_no']; ?></td>
                                        </tr>
										<tr>
                                        	<td style="background-color:#3dd;">Offender's Physical Appearance:</td>
                                        	<td><?php echo $row['driver_license']; ?></td>
                                        </tr>
										<tr>
                                        	<td style="background-color:#3dd;">Description:</td>
                                        	<td><?php echo $row['name']; ?></td>
                                        </tr>
										<tr>
                                        	<td style="background-color:#3dd;">Victim's Race / Ethnicity:</td>
