...
<li><a class="active" href="view-offence.php"><i class="glyphicon glyphicon-list-alt"></i> Reported Cases </a></li>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header-light">
                                <h4 class="title">Your Report Records</h4>
                                
                            </div>
                            <div class="content-light ">
							
							 <label for="filter">Search</label> <input type="text" name="filter" value="" id="myInput" placeholder="Offence ID" onKeyUp="myFunction()"/>
      ...
      if (td.innerHTML.toUpperCase().indexOf(filter) > -1) {
        ...
        tr[i].style.display = "none";
                                ...
                                <table class="table table-bordered" id="myTable">
									...
									<?php 
									$user = $_SESSION['user'];
	$result = $db->prepare("SELECT * FROM reported_offence where officer_reporting='$user' ORDER BY id DESC");
	$result->execute();
	for($i=0; $row = $result->fetch(); $i++){
?>
                                        <tr>
										<td><?php echo $row['offence_id']; ?></td>
                                        	<td><a rel="facebox" title="Click to view details" href="offence-detail.php?id=<?php echo $row['id']; ?>"><?php echo $row['offence']; ?><i class="fa fa-eye  fa-lg text-success"></i></a></td>
                                        	
											<td>
			<a href="#" id="<?php echo $row['id']; ?>" class="delbutton" title="Click to Delete the Offense"><i class="glyphicon glyphicon-trash"></i></a>
													</td>
